...
Public Sub InitResources()
    ...
    For x = 0 To Srf.Width * 1.2 Step size * Cos(Pi / 6)
        ...
        For y = -Srf.Width * 0.2 To Srf.Height * 1.2 Step size
            CC.DrawRegularPolygon x, y + (I Mod 2) * size * 0.5, size * 0.4, 6, splNone
            CC.Fill
        Next
    Next
    'Srf.FastBlur
    ...
    For x = 0 To Srf.Width * 1.2 Step size * Cos(Pi / 6)
        ...
        For y = -Srf.Width * 0.2 To Srf.Height * 1.2 Step size
            ...
            CC.DrawRegularPolygon x - size * 0.02, -size * 0.02 + y + (I Mod 2) * size * 0.5, size * 0.3, 6, splNone
            CC.Fill
