...
'                If D < MIND Then
'                    'Player Dead
'                    If Snake(0).IsDying = 0 Then MultipleSounds.playsound SoundPlayerDeath
'
'                    Snake(0).Kill: Exit For
'                End If
'
'            Next
'
...
'            R = Snake(I).DIAM * 0.5
'
'            For J = 0 To Snake(0).Ntokens - 1
'                TokenPosition = Snake(0).GetTokenPos(J)
'                Dx = HeadPosI.x - TokenPosition.x
'                Dy = HeadPosI.y - TokenPosition.y
'
'                D = Dx * Dx + Dy * Dy
